...
$PAGE->set_url( '/local/mb2builder/ajax/save-page.php' );
...
// Set record data
$data = Mb2builderPagesApi::set_record_data( array( 'itemid' => $itemid, 'pagename' => '', 'pageid' => $pageid, 'democontent' => $democontent ) );
