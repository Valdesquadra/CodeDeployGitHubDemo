...
$PAGE->set_url( '/local/mb2builder/ajax/reviews.php' );
...
{
    if ( function_exists( 'theme_mb2nl_get_featured_reviews' ) && function_exists( 'theme_mb2nl_shortcodes_reviews_template' ) )
    {
        $items = theme_mb2nl_get_featured_reviews( $options );
        echo theme_mb2nl_shortcodes_reviews_template( $items, $options );
    }
    else
    {
        echo 'Function doesn’t exist (theme_mb2nl_get_featured_reviews, theme_mb2nl_shortcodes_reviews_template).';
    }
