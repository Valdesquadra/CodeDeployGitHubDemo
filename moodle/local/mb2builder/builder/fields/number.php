...
class LocalMb2builderNumber
{
	...
	static function local_mb2builder_get_input($key, $attr)
	{
		...
		$output	.= '<input type="number" class="form-control mb2-pb-input mb2-pb-input-' . $key . '"' . $showon . $actions . ' data-attrname="' . $key . '" min="' . $attr['min'] . '" max="' . $attr['max'] . '" step="' . $attr['step'] . '" value="' . $attr['default'] . '" />';
