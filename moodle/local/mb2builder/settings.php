...
if ( $hassiteconfig )
{
	...
	// $name = 'local_mb2builder/teacherroleshortname';
	// $title = get_string('teacherroleshortname','local_mb2builder');
	// $setting = new admin_setting_configtext($name, $title, '', 'editingteacher');
	// $page->add( $setting );
	//
	// $name = 'local_mb2builder/studentroleshortname';
	// $title = get_string('studentroleshortname','local_mb2builder');
