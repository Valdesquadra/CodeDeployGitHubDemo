...
function mb2_shortcode_coursetabs($atts, $content= null){
	...
	$output .= '<div class="mb2-pb-content mb2-pb-coursetabs clearfix' . $cls . '"' . $style . $carouseldata . ' data-carousel="' . $carousel . '" data-columns="' . $columns . '" data-gutter="' . $gutter . '" data-limit="' . $limit . '" data-catdesc="' . $catdesc . '">';
