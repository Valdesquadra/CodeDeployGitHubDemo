...
class theme_mb2nl_external extends external_api
{
    ...
    public static function submit_subscribe_form( $formdata )
    {
        ...
        $opt = array(
            ...
            'price' => $formarray['filter_price'] !== '' ? $formarray['filter_price'] : -1,
     ...
     *
     */
    public static function set_courses_pagination( $page, $categories, $instructors, $price, $searchstr )
    {
        global $PAGE;
     ...
     *
     */
    public static function set_courses_search( $searchstr, $categories, $instructors, $price )
    {
        global $PAGE;
     ...
     *
     */
    public static function coursetabs( $category, $limit, $carousel, $columns, $gutter, $catdesc )
    {
        global $PAGE, $CFG;
        ...
        $courseopts = array();
        $courseopts['categories'] = array( $params['category'] );
        ...
        $courseopts['catdesc'] = $params['catdesc'];
