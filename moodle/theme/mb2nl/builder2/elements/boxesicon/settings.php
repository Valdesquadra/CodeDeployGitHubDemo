...
$mb2_settings = array(
	...
	'attr' => array(
		'type'=>array(
			...
			'class_remove' => 'type-1 type-2 type-3 type-4 type-5',
			'class_prefix' => 'type-',
			'globalparent' => 1
		),
		'columns'=>array(
		...
		'color'=>array(
			...
			'action' => 'class',
			'selector' => '.theme-boxicon',
			'class_remove' => 'color-primary color-secondary color-success color-warning color-info color-danger color-inverse',
			'class_prefix' => 'color-',
		),
		'ccolor'=>array(
			'type'=>'color',
