...
function mb2_shortcode_mb2pb_button( $atts, $content= null ){
	...
	// Button icon
	$btnicon = '<span class="hidden btn-incon"><i class="' . $icon . '"></i></span>';
	...
	// Button style
	if ( $fweight || $lspacing != 0 || $wspacing != 0 )
	{
		$btnstyle .= ' style="';
	...
	$output .= '<div class="mb2-pb-element mb2pb-button' . $elcls . '"' . $style . theme_mb2nl_page_builder_el_datatts( $atts, $atts2 ) . '>';
