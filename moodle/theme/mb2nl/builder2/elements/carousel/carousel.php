...
function mb2_shortcode_mb2pb_carousel( $atts, $content = null ){
	...
	if ( ! $content )
	{
		$demoimage = theme_mb2nl_page_builder_demo_image( '600x400' );
...
function mb2_shortcode_mb2pb_carousel_item( $atts, $content = null ){
	extract(mb2_shortcode_atts( array(
		...
		'title' => 'Title text',
		'image' => theme_mb2nl_page_builder_demo_image( '600x400' ),
	...
	$output .= '<div class="mb2-pb-carousel-item theme-slider-item" data-pbid="' . $pbid . '">';
