...
?>
<div class="course-header" style="background-image:url('<?php echo theme_mb2nl_get_enroll_hero_url(); ?>')">
	<div class="inner">
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						...
						<div class="course-heading hsize-2"><?php echo $COURSE->fullname; ?></div>
						...
						<span class="btn btn-xlg btn-primary course-enrolbtn"><?php echo $enrolbtntext; ?></span>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-9 enrol-contentcol">
				...
				<?php if ( $settings->skills ) : ?>
					<div class="details-section skills">
						<h2 class="details-heading hsize-2"><?php echo get_string( 'headingwhatlearn', 'format_mb2sections' ); ?></h2>
						<div class="details-content">
							<div class="content"><?php echo theme_mb2nl_static_content( $settings->skills ); ?></div>
						</div>
					</div>
				<?php endif; ?>
				<?php if ( $settings->elrollsections ) : ?>
			...
			<div class="col-md-3 enrol-sidebar">
				<div class="fake-block block-enrol">
					...
					<div class="enrol-info"><?php echo $enrlstring; ?></div>
					<span class="btn btn-lg btn-primary course-enrolbtn sidebar-btn btn-full"><?php echo $enrolbtntext; ?></span>
				</div>
