    ...
    <div id="main-header">
						...
						<div class="col-md-12">
							<div class="flexcols">
								<?php if ( $headercontent ) : ?>
									<div class="header-content"><?php echo theme_mb2nl_static_content( $headercontent, true, $headerlistopt ); ?></div>
								<?php endif; ?>
								<?php if ( $socialheader ) : ?>
		...
		<div class="header-inner2">
			...
			<div class="mobile-menu">
				<?php echo $OUTPUT->custom_menu(); ?>
				<?php if ( $headercontent || theme_mb2nl_theme_setting( $PAGE, 'socialheader' ) || theme_mb2nl_theme_setting( $PAGE, 'showsitemnu' ) ) : ?>
					<div class="extra-content">
						<?php echo theme_mb2nl_search_form( true ); ?>
						<?php //echo $OUTPUT->theme_part( 'site_menu', array( 'div' => false ) ); ?>
						<?php if ( $headercontent ) : ?>
							<?php echo theme_mb2nl_static_content( $headercontent, true, array( 'listcls' => 'mobile-header-list' ) ); ?>
						<?php endif; ?>
