...
function theme_mb2nl_get_scss_content()
{
	...
	// Header style
	$scss .= file_get_contents( $CFG->dirroot . '/theme/mb2nl/scss/theme/theme-header-' . $headerstyle . '.scss' );
	...
	{
		$scss .= file_get_contents( $CFG->dirroot . '/theme/mb2nl/scss/theme/theme-navheader.scss' );
		$scss .= file_get_contents( $CFG->dirroot . '/theme/mb2nl/scss/theme/theme-navheader-' . $headerstyle . '.scss' );
	}
	else
	{
		$scss .= file_get_contents( $CFG->dirroot . '/theme/mb2nl/scss/theme/theme-navbar.scss' );
		$scss .= file_get_contents( $CFG->dirroot . '/theme/mb2nl/scss/theme/theme-navbar-' . $headerstyle . '.scss' );
	}
