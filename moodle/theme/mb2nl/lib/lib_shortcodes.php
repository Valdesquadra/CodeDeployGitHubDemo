...
{
	return theme_mb2nl_course_list_courses( $courses, true, $builder );
}
...
function theme_mb2nl_shortcodes_reviews_template( $reviews, $opts = array() )
{
	...
	foreach ( $reviews as $review )
	{
		...
		$output .= '<div class="theme-course-review theme-box review-' . $review->id . ' course-' . $review->course . ' user-' . $review->createdby . '">';
...
function theme_mb2nl_shortcodes_teachers_template( $teachers, $opts = array() )
{
	...
	foreach ( $teachers as $teacher )
	{
		...
		$output .= '<div class="theme-course-teacher theme-box teacher-' . $teacher->id . '">';
 ...
 *
 */
function theme_mb2nl_get_video_url( $url )
{
