...
function theme_mb2nl_user_bookmarks()
{
	...
	foreach ( $tempbookmarks as $b )
	{
		...
		if ( $b_arr0 )
		{
			...
			$output .= '<span class="theme-bookmarks-form bookmark-edit" data-url="' . $b_arr0 . '" data-mb2bktitle="' . trim($title) . '"' . $bookmark_manage_attr . '><i class="fa fa-pencil"></i></span>';
			$output .= '<span class="theme-bookmarks-form bookmark-delete" data-url="' . $b_arr0 . '" data-mb2bktitle="' . trim($title) . '"><i class="fa fa-times"></i></span>';
			$output .= '</div>';
			$output .= '</li>';
	...
	$output .= '<span class="theme-bookmarks-form' . $bookmark_addremove . '" data-url="' . trim($bookmarkurl) . '" data-mb2bktitle="' . theme_mb2nl_page_title() . '"' . $bookmark_manage_attr . '>';
