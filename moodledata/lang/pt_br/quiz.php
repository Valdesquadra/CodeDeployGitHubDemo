...
/**
 * Strings for component 'quiz', language 'pt_br', version '3.11'.
 *
 * @package     quiz
 * @category    string
...
$string['addselectedquestionstoquiz'] = 'Adicionar perguntas selecionadas ao questionário';
...
$string['inactiveoverridehelp'] = '* O usuário não possui o grupo ou o papel correto para acessar o questionário, ou o questionário está oculto.';
