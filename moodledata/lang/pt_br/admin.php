...
$string['configallusersaresitestudents'] = 'Para atividades na página inicial, TODOS os usuários devem ser considerados estudantes? Se sim, qualquer pessoa com uma conta poderá participar como estudante nessas atividades. Se não, apenas os usuários que já são participantes de pelo menos um curso poderão participar dessas atividades. Somente administradores e professores especialmente definidos podem atuar como professores para essas atividades.';
...
$string['navshowfrontpagemods_help'] = 'Se habilitada, as atividades da página inicial serão exibidas na navegação sob páginas do site. Esta configuração só se aplica em temas com base no Classic.';
