...
$string['activityoverview'] = 'Você tem sessões agendada no BigBlueButton';
$string['bbbduetimeoverstartingtime'] = 'O horário de fechamento deve ser posterior ao horário de abertura.';
$string['bbbdurationwarning'] = 'A duração máxima para esta sessão é %duration% minutos.';
$string['bbbrecordallfromstartwarning'] = 'Esta sessão está sendo gravada desde o início.';
...
$string['bigbluebuttonbn:join'] = 'Participar de uma reunião do BigBlueButton';
...
$string['bigbluebuttonbn:view'] = 'Ver sala/atividade BigBlueButton';
...
$string['completionattendance'] = 'O estudante deve participar da reunião para:';
$string['completionattendance_desc'] = 'O estudante deve entrar na sala e permanecer na reunião por pelo menos {$a} minuto(s)';
...
$string['completionattendancegroup_help'] = 'É necessário participar da reunião por (n) minutos para conclusão.';
$string['completionengagement_desc'] = 'O estudante deve se envolver em atividades durante a reunião';
$string['completionengagementchats'] = 'Chats';
$string['completionengagementchats_desc'] = 'O estudante deve participar de {$a} chat(s) para concluir.';
$string['completionengagementchats_event_desc'] = '{$a} chat(s) criado(s)';
$string['completionengagementemojis'] = 'Emojis';
$string['completionengagementemojis_desc'] = 'O estudante deve enviar {$a} emoji(s) nas enquetes para conclusão.';
$string['completionengagementemojis_event_desc'] = '{$a} emoji(s) criado(s)';
...
$string['completionengagementpollvotes_desc'] = 'O estudante deve votar  {$a} vez(es) nas enquetes para concluir.';
$string['completionengagementraisehand_desc'] = 'O estudante deve levantar a mão {$a} vez(es) para concluir.';
...
$string['config_server_url_description'] = 'As credenciais padrão são para um <a href="https://bigbluebutton.org/free-bigbluebutton-service-for-moodle/" target="_blank">serviço BigBlueButton gratuito para Moodle (abre em nova janela)</a > fornecido pela Blindside Networks com as seguintes restrições:
<ol>
...
$string['messageprovider:recording_ready'] = 'Gravação do BigBlueButton pronta para ver';
