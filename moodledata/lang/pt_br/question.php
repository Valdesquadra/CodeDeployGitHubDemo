...
/**
 * Strings for component 'question', language 'pt_br', version '3.11'.
 *
 * @package     question
 * @category    string
...
$string['privacy:metadata:database:question_attempt_steps:fraction'] = 'A nota atribuída a essa pergunta foi dimensionada para um valor de 1.';
...
$string['privacy:metadata:database:question_attempts'] = 'As informações sobre uma tentativa de uma pergunta específica.';
...
$string['privacy:metadata:database:question_attempts:responsesummary'] = 'Um resumo da resposta da pergunta.';
$string['privacy:metadata:database:question_attempts:timemodified'] = 'O horário em que a tentativa de pergunta foi atualizada.';
...
$string['questionpreviewdefaults_desc'] = 'Esses padrões são usados quando um usuário visualiza primeiro uma pergunta no banco de questões. Uma vez que um usuário tenha inspecionado uma pergunta, suas preferências pessoais são armazenadas como preferências do usuário.';
...
$string['restoremultipletopcats'] = 'O arquivo de backup contém mais de uma categoria de pergunta de nível superior para o contexto {$a}.';
