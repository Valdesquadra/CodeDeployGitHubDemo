...
/**
 * Strings for component 'badges', language 'pt_br', version '3.11'.
 *
 * @package     badges
 * @category    string
...
$string['criteria_descr_0'] = 'Concluir <strong>{$a}</strong> dos requisitos listados.';
...
$string['sitebackpackverify'] = 'Conexão de mochila';
